...
exports.PricingModule = PricingModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [pricing_service_1.PricingService, pricing_engine_service_1.PricingEngineService],
        exports: [pricing_service_1.PricingService, pricing_engine_service_1.PricingEngineService],
    })
], PricingModule);
